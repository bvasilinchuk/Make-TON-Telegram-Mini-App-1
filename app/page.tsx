...
export default function Home() {
  ...
  return (
    <main className="p-4 bg-gradient-main min-h-screen px-4 flex flex-col items-center text-white font-medium">
      ...
      <section className="p-4 bg-gradient-main min-h-screen flex flex-col items-center text-white font-medium">
        {userData ? (
          <>
            <h1 className="text-2xl font-bold mb-4">User Data</h1>
            <ul>
